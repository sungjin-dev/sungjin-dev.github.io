...
해석: 
<br>
1. 먼저 `#grandpa`의 직계 자식인 `.father`를 찾는다. (>)
<br>
2. 그리고 그 `.father` 안에 있는 모든 `.text`를 찾는다. (공백)
<br>
결과: `2, 3번`만 굵어짐
<br><br>
>예시 B
...
<br><br>
해석: 
1. `#grandpa`의 직계 자식인 `.father`를 찾고 (>)
2. 그 `.father`의 직계 자식인 `.text`만 적용. (>)
<br><br>
결과: `2번`만 밑줄. (3번은 section이라는 벽이 하나 더 있어서 탈락한다.)
<br><br>
