...
flowchart LR
    %% SCSS에서 정의한 blog-mermaid-transparent 클래스를 노드 A에 적용합니다.
    %% 여기에 display: block;을 다시 추가하여 인라인 요소의 기본 세로 패딩 문제를 해결합니다.
    A("<img src='/assets/images/human.png' width='50' style='display: block;'/><br/>학생")
    
    A:::blog-mermaid-transparent
