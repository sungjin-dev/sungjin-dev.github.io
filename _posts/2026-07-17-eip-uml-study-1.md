...
flowchart LR
    ...
    A("<div style='min-height:90px; display:flex; flex-direction:column; align-items:center; justify-content:center;'><img src='/assets/images/human.png' style='width:40px; height:auto; display:block;'/><span style='margin-top:5px;'>학생</span></div>"):::trans
